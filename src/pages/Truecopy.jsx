...
const DegreeCertificateRequestForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Use fetch or axios to send form data
  };

  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md w-full max-w-lg">
        <h2 className="text-xl font-bold mb-4 text-cyan-900">Request true copy of degree certificate</h2>
        ...
        {[
          ...
          ['How many true copies do you want', 'numberOfCopies'],
        ].map(([label, name]) => (
